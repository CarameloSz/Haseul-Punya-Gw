...
module.exports = {
    ...
    run: async (client, message, args) => {
        // code here
        message.guild.channels.create("Haseul Music - Requests", {
            type: 'category',
            ...
            message.guild.channels.create(`🎧｜Haseul Music`, {
                ...
                message.guild.channels.create(`🎵｜requests`, {
                    ...
                    topic: `To request a Track, simply Type the **SONG NAME** into the Channel or the **URL** and the Bot will play it! Make sure that you are in the **right** Voice Channel (🎧｜Haseul Music)!`,
                    parent: channel1.id,
                    permissionOverwrites: [{
                        id: message.guild.id,
                    ...
                    let pehla = new MessageEmbed()
                        ...
                        .setTitle("Haseul Music | Request | Guide")
                        .setDescription(`Enter the song name or URL to play a song\n\n For Example ${config.prefix}play \`Rockstar baby song\``)
                        .setFooter("Made By CarameloSzy")

                    let dusra = new MessageEmbed()
                        .setColor(config.colors.yes)
                        .setThumbnail(client.user.displayAvatarURL())
                        .setAuthor(message.author.username)
                        .setTitle("CarameloSzy - Best Free Music Bot of 2021")
                        .setDescription(`Join a voice channel and enter a song name or url to play.\n[Invite Haseul Music](https://discord.com/oauth2/authorize?client_id=708931649265598534&permissions=8&scope=bot) • [Join Server](https://discord.gg/fqjdsyEq24) • [Subscribe Now](https://www.youtube.com/CarameloSzy)`)
                        .setImage('https://c.tenor.com/WIkoA-5SxTUAAAAC/loona-hyunjin.gif')
                        .setFooter("Made By CarameloSzy")
